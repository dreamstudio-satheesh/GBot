...
INSERT INTO users (tenant_id, first_name, last_name, username, email, password_hash, role) VALUES
    (1, 'Admin', 'Store', 'admin_store', 'admin@store.com', 'hashed_password', 'admin'),
    (1, 'Support', 'Agent', 'support_store', 'support@store.com', 'hashed_password', 'support'),
    (1, 'Customer', 'User', 'customer1', 'customer1@store.com', 'hashed_password', 'user'),
    
    (2, 'Admin', 'Support', 'admin_support', 'admin@support.com', 'hashed_password', 'admin'),
    (2, 'Support', 'Agent', 'agent_support', 'agent@support.com', 'hashed_password', 'support'),
    
    (3, 'Admin', 'Health', 'admin_health', 'admin@health.com', 'hashed_password', 'admin'),
    (3, 'Doctor', 'Smith', 'doctor_smith', 'smith@health.com', 'hashed_password', 'support');
